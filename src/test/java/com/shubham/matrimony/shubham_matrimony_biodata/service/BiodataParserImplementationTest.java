...
class BiodataParserImplementationTest {
  ...
  private final BiodataParserImplementation parser = new BiodataParserImplementation();
  ...
  void shouldParseNativeTeluguScriptProfileAndHandleCompoundFatherOccupation() {
    ...
    // CRITICAL CHECK: Compound "తండ్రి ఉద్యోగం" must attribute to fatherOccupation,
    // NOT fatherName!
