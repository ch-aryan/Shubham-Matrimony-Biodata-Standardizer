 ...
 * <li>{@link #MEDIUM} — heuristic or fuzzy match that may warrant quick
 * operator verification.</li>
 * <li>{@link #LOW} — weak match; likely needs human review.</li>
 * <li>{@link #CONFLICT} — multiple competing values discovered for the same
 * field.</li>
