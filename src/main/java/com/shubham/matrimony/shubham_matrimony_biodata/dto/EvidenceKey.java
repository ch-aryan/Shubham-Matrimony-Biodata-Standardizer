 ...
 *
 * <p>
 * By bucketing evidence under {@code (context, field)}, data belonging to
 * different entities
 * (e.g. candidate's name vs sibling's name vs father's name) are completely
 * isolated and
 ...
 * @param field   the canonical field type (e.g. FULL_NAME, OCCUPATION,
 *                DATE_OF_BIRTH)
 */
