...
/**
 * The output of {@code ExtractionMerger}, encapsulating the synthesized {@link ProfileBiodata},
 * the field-level confidence scores, all detected conflicts, and the complete audit trail
...
public class MergeResult {
    ...
    /** Confidence level per canonical field property name (HIGH, MEDIUM, LOW, CONFLICT, MISSING). */
    @Builder.Default
     ...
     *
     * @return {@code true} if at least one conflict was recorded; {@code false} otherwise.
     */
