...
/**
 * Global exception handler providing structured JSON diagnostics adhering to ParseResponse
                ...
                ParseResponse.builder()
                        ...
                        .warnings(List.of(
                                ParseWarning.builder()
                                        ...
                                        .message("Media type is not supported: " + ex.getContentType())
                                        .build()
                        ))
                        .build()
        );
        ...
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(
                ParseResponse.builder()
                        ...
                        .warnings(List.of(
                                ParseWarning.builder()
                                        .category(WarningCategory.LOW_INFORMATION_INPUT)
                                        .message("An unexpected error occurred while processing the biodata: " + ex.getMessage())
                                        .build()
                        ))
                        .build()
        );
